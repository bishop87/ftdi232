...
type FT_Device_Info_Node = record
  ...
  ID            : DWord;
  LocID         : DWord;
  SerialNumber  : array [0..15] of AnsiChar;  //-------variate char in ansichar  (21-4-2012)
...
TFT_Program_Data = record
  ...
  VendorID          : Word;
  ProductID         : Word;
  Manufacturer      : PansiChar;    //------variate pchar in pansichar  (21-4-2012)
...
Function Open_USB_Device_By_Serial_Number(Serial_Number: ansistring) : FT_Result;       //-----corretta da string ad ansistring
Function Open_USB_Device_By_Device_Description(Device_Description: ansistring) : FT_Result;   //-----corretta da string ad ansistring
...
Function USB_FT_GetDeviceInfo(DevType,ID:DWord; SerialNumber,Description:array of ansichar) : FT_Result;
...
//  Deposit for Get latency timer
    ...
    Manufacturer: array [0..63] of ansichar;        //---------- variate char in ansichar (21-4-2012)
    ManufacturerID: array [0..15] of ansichar;      //              "     "    "     "
    Description:  array [0..63] of ansichar;        //              "     "    "     "
...
// Used By FT_ListDevices
   ...
   FT_Device_String_Buffer : array [1..50] of ansiChar;   //-----corretta da char ad ansichar (21-4-2012)

   FT_Device_String : ansiString;  //-----corretta da string ad ansistring
...
Function GetDeviceString : AnsiString;      //-----corretta da string ad ansistring
Var I : Integer;
Begin
Result := ''; I := 1;
...
Procedure SetDeviceString (S: AnsiString);   //corretta da string ad ansistring
Var I,L : Integer;
Begin
...
//Function USB_FT_GetDeviceInfo(DevType,ID:DWord; SerialNumber,Description:array of char) : FT_Result;
// --------- corretta testata della funzione come prototipo  (21-4-2012)
Function USB_FT_GetDeviceInfo(DevType,ID:DWord; SerialNumber,Description:array of ansichar) : FT_Result;
begin
