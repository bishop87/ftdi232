...
type
  TForm1 = class(TForm)
    ...
    procedure mbusout1Click(Sender: TObject);
  private
...
If SaveDialog1.Execute then
  ...
  Repeat
   ...
   Application.ProcessMessages;
   I := Read_USB_Device_Buffer(FT_Q_Bytes);//FT_In_Buffer_Size);
   Total := Total + I;
...
procedure TForm1.mbusout1Click(Sender: TObject);
 var
  total,I : Integer;
  S : String;
 begin
  ...
  FT_Out_Buffer[2] := 67;
  total := 3;
  I := Write_USB_Device_Buffer( total );
  If I <> total then Memo1.Lines.Add('USB Device Write fallita...');
 end;
